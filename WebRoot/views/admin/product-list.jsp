...
<link rel="stylesheet" href="<%=basePath%>/resources/admin/lib/zTree/v3/css/zTreeStyle/zTreeStyle.css" type="text/css">
<!--[if IE 6]>
...
<script type="text/javascript" src="<%=basePath%>/resources/admin/lib/datatables/1.10.0/jquery.dataTables.min.js"></script> 
<script type="text/javascript" src="<%=basePath%>/resources/admin/lib/zTree/v3/js/jquery.ztree.all-3.5.min.js"></script> 
