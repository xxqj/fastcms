...
import com.fast.common.constants.PagePrefix;
import com.fast.common.utils.BeanUtilsExt;
import com.fast.common.utils.StringUtilsExt;

/**  
 * @Title: ControllerPath.java
 * @Package com.fast.web.controller
 * @Description: Controller路径构建起
 * @author 喧嚣求静
 * @date 2016-3-26
 * blog:913.iteye.com
 */
public class ControllerPath {
	...
	public ControllerPath(Class<?> genericClass) {
		...
		entityClass = BeanUtilsExt.getGenericClass(genericClass);
	...
	public String getOneViewPath() {
		...
		sb.append(StringUtilsExt.toUpperCaseFirstOne(entityName));
		return sb.toString();
	}
	...
	private String[] getWords(String str) {
		if (StringUtilsExt.isEmpty(str)) return null;
