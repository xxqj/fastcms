...
<script type="text/javascript" src="<%=basePath%>/resources/admin/lib/Validform/5.3.2/Validform.min.js"></script>  
<script type="text/javascript" src="<%=basePath%>/resources/admin/lib/layer/2.1/layer.js"></script><script type="text/javascript" src="lib/laypage/1.2/laypage.js"></script> 
...
<script type="text/javascript" src="<%=basePath%>/resources/admin/js/H-ui.admin.system.js"></script>
<script>
var _hmt = _hmt || [];
(function() {
