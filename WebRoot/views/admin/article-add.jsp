...
<script type="text/javascript" src="<%=basePath%>/resources/admin/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="<%=basePath%>/resources/admin/lib/ueditor/1.4.3/ueditor.config.js"></script> 
<script type="text/javascript" src="<%=basePath%>/resources/admin/lib/ueditor/1.4.3/ueditor.all.min.js"> </script> 
<script type="text/javascript" src="<%=basePath%>/resources/admin/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
...
$(function(){
	...
	var uploader = WebUploader.create({
		auto: true,
		swf: '<%=basePath%>/resources/admin/lib/webuploader/0.1.5/Uploader.swf',
