...
<title>新增图片</title>
<link href="<%=basePath%>/resources/admin/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<script type="text/javascript" src="<%=basePath%>/resources/admin/h-ui/js/comment.js"></script>
<!--/_footer /作为公共模版分离出去-->
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('<%=basePath%>/resources/admin/lib/webuploader/0.1.5/server/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
