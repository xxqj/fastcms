...
<script type="text/javascript" src="<%=basePath%>/resources/admin/lib/Highcharts/4.1.7/js/highcharts.js"></script>
<script type="text/javascript" src="<%=basePath%>/resources/admin/lib/Highcharts/4.1.7/js/modules/exporting.js"></script>
<script type="text/javascript" src="<%=basePath%>/resources/admin/lib/Highcharts/4.1.7/js/highcharts-3d.js"></script>
